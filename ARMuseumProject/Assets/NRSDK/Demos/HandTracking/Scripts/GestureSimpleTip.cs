...
namespace NRKernal.NRExamples
{
    public class GestureSimpleTip : MonoBehaviour
    {
        ...
        {
            public const string Gesture_Open_Hand = "松开";
            public const string Gesture_Grab = "握拳";
            public const string Gesture_Pinch = "捏住";
            public const string Gesture_Point = "伸出食指";
            public const string Gesture_Victory = "胜利";
            public const string Gesture_Call = "打电话";
            public const string Gesture_System = "返回系统";
        }
        ...
        private const string RIGHT_HAND_LABEL = "右手：";
        private const string LEFT_HAND_LABEL = "左手：";
