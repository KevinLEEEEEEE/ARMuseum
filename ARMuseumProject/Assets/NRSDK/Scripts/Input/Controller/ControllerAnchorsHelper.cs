...
namespace NRKernal
{
    ...
    public class ControllerAnchorsHelper : MonoBehaviour
    {
        ...
        // User add
        [SerializeField]
        private Transform m_RightHandLaserAnchor;
        [SerializeField]
        private Transform m_LeftHandLaserAnchor;
        [SerializeField]
        private Transform m_RightColliderEntity;
        [SerializeField]
        private Transform m_LeftColliderEntity;
        ...
        public Transform GetAnchor(ControllerAnchorEnum anchorEnum)
        {
            switch (anchorEnum)
            {
                ...
                // User add
                case ControllerAnchorEnum.RightHandLaserAnchor:
                    return m_RightHandLaserAnchor;
                case ControllerAnchorEnum.LeftHandLaserAnchor:
                    return m_LeftHandLaserAnchor;
                case ControllerAnchorEnum.RightColliderEntity:
                    return m_RightColliderEntity;
                case ControllerAnchorEnum.LeftColliderEntity:
                    return m_LeftColliderEntity;
                default:
                    break;
            }
            return null;
