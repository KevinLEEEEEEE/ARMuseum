...
public class ClockBlockManager : MonoBehaviour
{
    ...
    public void Reset()
    {
        ...
        rustBlock.transform.rotation = Quaternion.Euler(0, 0, 0);
    ...
    private async void UnloadEventHandler()
    {
        ...
        // 更换材质并开始RustBlock消散动画
        rendererComp.material = dissolveMaterial;

        DOTween.To(() => clipStart, r => {
    ...
    private void UpdateRotation(float percentage)
    {
        ...
        rustBlock.transform.localRotation = Quaternion.Euler(0, angleY, 0);
    }
